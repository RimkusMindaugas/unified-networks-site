...
That is why this job started with a [Wi-Fi site survey and heatmap report](/services/wifi-site-survey-and-heatmap-dublin), not a guess.
...
<figure>
  <img src="/job-sean/heatmap.jpg" alt="Wi-Fi heatmap plan for Sean's new build home in County Dublin" loading="lazy" />
  <figcaption>The heatmap plan made it clear where coverage was needed before Sean moved in.</figcaption>
</figure>
...
<figure>
  <img src="/job-sean/starlink.jpg" alt="Starlink installed neatly at the back of the outbuilding for Sean's new build in Dublin" loading="lazy" />
  <figcaption>Starlink was mounted neatly out of sight at the back of the outbuilding.</figcaption>
</figure>
...
<figure>
  <img src="/job-sean/socket-ports.jpg" alt="Front ethernet ports on a UniFi U7 In-Wall access point in Sean's new build home" loading="lazy" />
  <figcaption>The UniFi U7 In-Wall access point also gives Sean 2 local ethernet ports for devices like TVs, printers, or Sky boxes.</figcaption>
</figure>

<figure>
  <img src="/job-sean/accesspoint.jpg" alt="UniFi U7 In-Wall access point installed neatly in Sean's new build home" loading="lazy" />
  <figcaption>The UniFi U7 In-Wall units kept the install neat while still giving local wired connections where needed.</figcaption>
</figure>

And the switch matters more than most new build owners realise.

Many homes have ethernet sockets installed during the build, but they are not actually useful until they are connected properly at the central point. We covered that in more detail here: [Ethernet Sockets in Your New Build Don't Work? Here's What's Missing](/ethernet-sockets-need-a-switch-new-build-ireland/).

<figure>
  <img src="/job-sean/comms-cabinet.jpg" alt="Comms cabinet with Dream Machine SE and networking gear for Sean's new build" loading="lazy" />
  <figcaption>The central cabinet keeps the router, switching, and patching tidy and easy to manage.</figcaption>
</figure>
...
1. Fibre is not live yet, even when the house is nearly complete.
2. Modern building materials make one-router Wi-Fi far less reliable than people expect.
