...
One unit at building A.
One unit at building B.
...
If you also need wired backbone on site, [structured cabling services](/services/structured-cabling-cat6-cat6a-fibre-dublin) pair well with PtP.
...
1. confirm line of sight from both points
2. check mounting options and height
3. define required speed for real usage
4. decide if remote side needs local Wi-Fi too
5. plan power and cable protection at both ends
...
That is where [Wi-Fi installation and setup](/services/wifi-installation-and-setup-dublin) comes in.
...
That is where a [managed Wi-Fi monthly plan](/services/managed-wifi-plan-monthly-dublin) can help keep performance steady over time.
