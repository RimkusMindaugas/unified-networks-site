...
image: "~/assets/images/sean-new-build-wifi-heatmap-dublin.jpg"
category: Wi-Fi
tags:
  - wifi
  - heatmap
...
If that sounds familiar, read this first: [How to Check if Your Internet Is Slow or Your Wi-Fi Is Weak](/how-to-tell-slow-internet-vs-weak-wifi/).

## Common mistakes people make before calling for a survey

1. buying random extenders and hoping for magic
2. testing with one old phone and assuming the whole network is bad
3. moving the router three times instead of fixing layout
4. mixing old and new gear with no plan
5. assuming every issue is the ISP
...
1. explains findings in plain language
2. gives a practical step-by-step fix plan
3. is willing to work with some existing hardware when it makes sense
...
If you also need implementation, [Wi-Fi installation and setup](/services/wifi-installation-and-setup-dublin) and [Wi-Fi dead zone fixes](/services/wifi-dead-zone-fixes-dublin) are usually the next step after the report.
