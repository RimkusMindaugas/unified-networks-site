...
1. If you are close to the router or AP, use 5 GHz.
2. If you are far away or behind multiple walls, 2.4 GHz may be more stable.
3. If 5 GHz is unstable in a room, do not force it. Use the band that is actually reliable there.
...
1. Test speed beside router on a newer device.
2. Test speed in each key room.
3. In strong-signal rooms, prefer 5 GHz.
4. In weak-signal rooms, test 2.4 GHz stability.
